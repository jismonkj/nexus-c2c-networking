...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    ...
    //fetch user profile
    axios.get("/member/profile/" + this.$root.user.id).then(function (response) {
  ...
  methods: {
    saveProfile: function saveProfile() {
      ...
      axios.put("/member/profile/0", this.$data.profile).then(function (response) {
        ...
        if (response.data) {
          _this2.btnTitle = "Profile is Updated";
        } else {
          _this2.btnTitle = "Something went wrong! Try again.";
        }
      });
    },
                          ...
                          _c(
                            ...
                            [
                              _c(
                                "router-link",
                                {
                                  attrs: { to: "/account/education-employment" }
                                },
                                [
                                  _vm._v(
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    {
                                      attrs: {
                                        to: "/account/education-employment"
                                      }
                                    },
                                    [
                                      _vm._v(
          ...
          _c("div", { staticClass: "col-4" }, [
            _c("div", { staticClass: "ui-block" }, [
              _c("div", { staticClass: "available-widget" }, [
                _c("div", { staticClass: "h6 title" }, [_vm._v("Electronics")]),
                _vm._v(" "),
...
Vue.component('ProfilePage', _components_member_profile_page_vue__WEBPACK_IMPORTED_MODULE_6__["default"]); // routes
// __________________
