          ...
          <div class="row">
            ...
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="form-group with-icon label-floating">
                ...
                >
                <svg
                  class="svg-inline--fa fa-facebook-f fa-w-9 c-facebook"
                  aria-hidden="true"
                  data-prefix="fab"
              ...
              <div class="form-group with-icon label-floating">
                ...
                >
                <svg
                  class="svg-inline--fa fa-twitter fa-w-16 c-twitter"
                  aria-hidden="true"
                  data-prefix="fab"
                  data-icon="twitter"
                  role="img"
              ...
              <div class="form-group with-icon label-floating">
                ...
                <input
                  ...
                  v-model="profile.dribble"
                >
                <svg
                  class="svg-inline--fa fa-dribbble fa-w-16 c-dribbble"
                  aria-hidden="true"
                  data-prefix="fab"
                  data-icon="dribbble"
                  role="img"
...
export default {
  ...
  methods: {
    ...
    getStates: function() {
      ...
      axios.get("/state/" + this.profile.country_id).then(response => {
