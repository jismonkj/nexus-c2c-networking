        ...
        <div class="ui-block-content">
          ...
          <ul class="widget w-personal-info">
            <li>
              ...
              <span class="text">{{ user.about_you }}</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span class="text">{{ user.birth_place }}</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span class="text">{{ user.relationship }}</span>
            </li>
            <li>
              <span class="title">Email:</span>
              <a href="#" class="text">{{ userBasic.user.email }}</a>
            </li>
            <li>
              <span class="title">Website:</span>
              <a href="#" class="text">{{ user.website }}</a>
            </li>
            <li>
