                ...
                <li>
                    <a href="03-Newsfeed.html">
                        <svg class="olymp-newsfeed-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-newsfeed-icon') }}"></use>
                        </svg>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="17-FriendGroups.html">
                        <svg class="olymp-happy-faces-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-happy-faces-icon') }}"></use>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="18-MusicAndPlaylists.html">
                        <svg class="olymp-headphones-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-headphones-icon') }}"></use>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="19-WeatherWidget.html">
                        <svg class="olymp-weather-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-weather-icon') }}"></use>
                        </svg>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="24-CommunityBadges.html">
                        <svg class="olymp-badge-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-badge-icon') }}"></use>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="25-FriendsBirthday.html">
                        <svg class="olymp-cupcake-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-cupcake-icon') }}"></use>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="26-Statistics.html">
                        <svg class="olymp-stats-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-stats-icon') }}"></use>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="27-ManageWidgets.html">
                        <svg class="olymp-manage-widgets-icon left-menu-icon" data-toggle="tooltip" data-placement="right"
                            ...
                            <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-manage-widgets-icon') }}"></use>
                        </svg>
                    </a>
                </li>
            </ul>
    ...
    <div class="fixed-sidebar-right sidebar--small" id="sidebar-right">
        ...
        <a href="#" class="olympus-chat inline-items js-chat-open">
            <svg class="olymp-chat---messages-icon">
                <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-chat---messages-icon') }}"></use>
            </svg>
        </a>
                ...
                <li class="inline-items js-chat-open">
                    ...
                    <div class="more"><svg class="olymp-three-dots-icon">
                        ...
                        <ul class="more-icons">
                            ...
                            <li>
                                <svg data-toggle="tooltip" data-placement="top" data-original-title="ADD TO CONVERSATION"
                                    class="olymp-add-to-conversation-icon">
                                    <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-add-to-conversation-icon') }}"></use>
                                </svg>
                            </li>
                            ...
                            <li>
                                <svg data-toggle="tooltip" data-placement="top" data-original-title="BLOCK FROM CHAT"
                                    ...
                                    <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-block-from-chat-icon') }}"></use>
                                </svg>
                            </li>
                        </ul>
        ...
        <div class="search-friend inline-items">
            ...
            <a href="29-YourAccount-AccountSettings.html" class="settings">
                <svg class="olymp-settings-icon">
                    <use xlink:href="{{ asset('theme/svg-icons/sprites/icons.svg#olymp-settings-icon') }}"></use>
                </svg>
            </a>
                        ...
                        <ul class="notification-list chat-message">
                            ...
                            <li>
                                ...
                                <div class="notification-event">
                                    ...
                                    <span class="chat-message-item">We’ll have to check that at the office and see if
                            ...
                            <li class="un-read">
                                ...
                                <div class="notification-event">
                                    <div>You and <a href="#" class="h6 notification-friend">Nicholas Grissom</a> just
                                        became friends. Write on <a href="#" class="notification-link">his wall</a>.</div>
                            ...
                            <li>
                                ...
                                <div class="notification-event">
                                    <div><a href="#" class="h6 notification-friend">Green Goo Rock</a> invited you to
                                        attend to his event Goo in <a href="#" class="notification-link">Gotham Bar</a>.</div>
                                    <span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">March
