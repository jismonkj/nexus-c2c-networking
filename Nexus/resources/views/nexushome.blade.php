...
<div class="fixed-sidebar">
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
		...
		<a href="02-ProfilePage.html" class="logo">
			<div class="img-wrap">
				<img src="{{ asset('theme/img/logo.png') }}" alt="Olympus">
			</div>
		</a>
			...
			<div class="control-block">
				<div class="author-page author vcard inline-items">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/author-page.jpg') }}" class="avatar">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="chat-users">
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar67-sm.jpg') }}" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar62-sm.jpg') }}" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				...
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar68-sm.jpg') }}" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				...
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar69-sm.jpg') }}" class="avatar">
				...
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar70-sm.jpg') }}" class="avatar">
						<span class="icon-status disconected"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar64-sm.jpg') }}" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar71-sm.jpg') }}" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar72-sm.jpg') }}" class="avatar">
						<span class="icon-status away"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="{{ asset('theme/img/avatar63-sm.jpg') }}" class="avatar">
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list chat-message">
							<li class="message-unread">
								<div class="author-thumb">
									<img src="{{ asset('theme/img/avatar59-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('theme/img/avatar60-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('theme/img/avatar61-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
							...
							<li class="chat-group">
								<div class="author-thumb">
									<img src="{{ asset('theme/img/avatar11-sm.jpg') }}" alt="author">
									<img src="{{ asset('theme/img/avatar12-sm.jpg') }}" alt="author">
									<img src="{{ asset('theme/img/avatar13-sm.jpg') }}" alt="author">
									<img src="{{ asset('theme/img/avatar10-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
			...
			<div class="ui-block">
				<div class="top-header">
					<div class="top-header-thumb">
						<img src="{{ asset('theme/img/top-header1.jpg') }}" alt="nature">
					</div>
					...
					<div class="top-header-author">
						<a href="02-ProfilePage.html" class="author-thumb">
							<img src="{{ asset('theme/img/author-main1.jpg') }}" alt="author">
						</a>
				...
				<div class="ui-block">
					...
					<article class="hentry post">
							...
							<div class="post__author author vcard inline-items">
								<img src="{{ asset('theme/img/author-page.jpg') }}" alt="author">
							...
							<div class="post-additional-info inline-items">
								...
								<ul class="friends-harmonic">
									<li>
										<a href="#">
											<img src="{{ asset('theme/img/friend-harmonic7.jpg') }}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
											<img src="{{ asset('theme/img/friend-harmonic8.jpg') }}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
											<img src="{{ asset('theme/img/friend-harmonic9.jpg') }}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
											<img src="{{ asset('theme/img/friend-harmonic10.jpg') }}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
											<img src="{{ asset('theme/img/friend-harmonic11.jpg') }}" alt="friend">
										</a>
									</li>
								</ul>
					...
					<article class="hentry post video">
							...
							<div class="post-video">
								<div class="video-thumb">
									<img src="{{ asset('theme/img/video5.jpg') }}" alt="photo">
				...
				<div class="ui-block">
					...
					<ul class="comments-list">
						...
						<li class="comment-item has-children">
							<div class="post__author author vcard inline-items">
								<img src="{{ asset('theme/img/avatar5-sm.jpg') }}" alt="author">
							...
							<ul class="children">
								<li class="comment-item">
									<div class="post__author author vcard inline-items">
										<img src="{{ asset('theme/img/avatar8-sm.jpg') }}" alt="author">
								...
								<li class="comment-item">
									<div class="post__author author vcard inline-items">
										<img src="{{ asset('theme/img/avatar2-sm.jpg') }}" alt="author">
						...
						<li class="comment-item">
							<div class="post__author author vcard inline-items">
								<img src="{{ asset('theme/img/avatar4-sm.jpg') }}" alt="author">
				...
				<div class="ui-block">
					...
					<article class="hentry post has-post-thumbnail shared-photo">
							...
							<div class="post-thumb">
								<img src="{{ asset('theme/img/post-photo6.jpg') }}" alt="photo">
							</div>
							...
							<div class="post-additional-info inline-items">
								...
								<ul class="friends-harmonic">
									<li>
										<a href="#">
											<img src="{{ asset('theme/img/friend-harmonic5.jpg') }}" alt="friend">
										</a>
									</li>
									<li>
										<a href="#">
									...
									<li>
										<a href="#">
											<img src="{{ asset('theme/img/friend-harmonic2.jpg') }}" alt="friend">
										</a>
									</li>
								</ul>
					...
					<div class="ui-block">
						...
						<div class="ui-block-content">
							...
							<ul class="widget w-badges">
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge1.png') }}" alt="author">
										<div class="label-avatar bg-primary">2</div>
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge4.png') }}" alt="author">
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge3.png') }}" alt="author">
										<div class="label-avatar bg-blue">4</div>
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge6.png') }}" alt="author">
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge11.png') }}" alt="author">
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge8.png') }}" alt="author">
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge10.png') }}" alt="author">
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge13.png') }}" alt="author">
										<div class="label-avatar bg-breez">2</div>
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge7.png') }}" alt="author">
									</a>
								</li>
								<li>
									<a href="24-CommunityBadges.html">
										<img src="{{ asset('theme/img/badge12.png') }}" alt="author">
									</a>
								</li>
							</ul>
							...
							<ul class="widget w-last-photo js-zoom-gallery">
								<li>
									<a href="img/last-photo10-large.jpg">
										<img src="{{ asset('theme/img/last-photo10-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot11-large.jpg">
										<img src="{{ asset('theme/img/last-phot11-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot12-large.jpg">
										<img src="{{ asset('theme/img/last-phot12-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot13-large.jpg">
										<img src="{{ asset('theme/img/last-phot13-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot14-large.jpg">
										<img src="{{ asset('theme/img/last-phot14-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot15-large.jpg">
										<img src="{{ asset('theme/img/last-phot15-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot16-large.jpg">
										<img src="{{ asset('theme/img/last-phot16-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot17-large.jpg">
										<img src="{{ asset('theme/img/last-phot17-large.jpg') }}" alt="photo">
									</a>
								</li>
								<li>
									<a href="img/last-phot18-large.jpg">
										<img src="{{ asset('theme/img/last-phot18-large.jpg') }}" alt="photo">
									</a>
								</li>
							</ul>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="home" role="tabpanel" aria-expanded="true">
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo1.jpg') }}" alt="photo">
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo2.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo3.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo4.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo5.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo6.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo7.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo8.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
						<div class="choose-photo-item" data-mh="choose-item">
							<div class="radio">
								<label class="custom-radio">
									<img src="{{ asset('theme/img/choose-photo9.jpg') }}" alt="photo">
									<input type="radio" name="optionsRadios">
								</label>
							</div>
						</div>
					...
					<div class="tab-pane" id="profile" role="tabpanel" aria-expanded="false">
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<figure>
								<img src="{{ asset('theme/img/choose-photo10.jpg') }}" alt="photo">
								<figcaption>
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<figure>
								<img src="{{ asset('theme/img/choose-photo11.jpg') }}" alt="photo">
								<figcaption>
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<figure>
								<img src="{{ asset('theme/img/choose-photo12.jpg') }}" alt="photo">
								<figcaption>
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<figure>
								<img src="{{ asset('theme/img/choose-photo13.jpg') }}" alt="photo">
								<figcaption>
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<figure>
								<img src="{{ asset('theme/img/choose-photo14.jpg') }}" alt="photo">
								<figcaption>
						...
						<div class="choose-photo-item" data-mh="choose-item">
							<figure>
								<img src="{{ asset('theme/img/choose-photo15.jpg') }}" alt="photo">
								<figcaption>
...
<div class="window-popup playlist-popup" tabindex="-1" role="dialog" aria-labelledby="playlist-popup" aria-hidden="true">
	...
	<table class="playlist-popup-table">
		...
		<tr>
			...
			<td class="cover">
				<div class="playlist-thumb">
					<img src="{{ asset('theme/img/playlist19.jpg') }}" alt="thumb-composition">
				</div>
			</td>
		...
		<tr>
			...
			<td class="cover">
				<div class="playlist-thumb">
					<img src="{{ asset('theme/img/playlist6.jpg') }}" alt="thumb-composition">
				</div>
			</td>
			<td class="song-artist">
				<div class="composition">
		...
		<tr>
			...
			<td class="cover">
				<div class="playlist-thumb">
					<img src="{{ asset('theme/img/playlist7.jpg') }}" alt="thumb-composition">
				</div>
			</td>
			<td class="song-artist">
				<div class="composition">
		...
		<tr>
			...
			<td class="cover">
				<div class="playlist-thumb">
					<img src="{{ asset('theme/img/playlist8.jpg') }}" alt="thumb-composition">
				</div>
			</td>
			<td class="song-artist">
				<div class="composition">
		...
		<tr>
			...
			<td class="cover">
				<div class="playlist-thumb">
					<img src="{{ asset('theme/img/playlist9.jpg') }}" alt="thumb-composition">
				</div>
			</td>
			<td class="song-artist">
				<div class="composition">
		...
		<tr>
			...
			<td class="cover">
				<div class="playlist-thumb">
					<img src="{{ asset('theme/img/playlist10.jpg') }}" alt="thumb-composition">
				</div>
			</td>
			<td class="song-artist">
				<div class="composition">
		...
		<div class="modal-body">
			<div class="mCustomScrollbar">
				<ul class="notification-list chat-message chat-message-field">
					<li>
						<div class="author-thumb">
							<img src="{{ asset('theme/img/avatar14-sm.jpg') }}" alt="author" class="mCS_img_loaded">
						</div>
						<div class="notification-event">
					...
					<li>
						<div class="author-thumb">
							<img src="{{ asset('theme/img/author-page.jpg') }}" alt="author" class="mCS_img_loaded">
						</div>
						<div class="notification-event">
			...
			<div class="add-options-message">
				...
				<div class="options-message smile-block">
					...
					<ul class="more-dropdown more-with-triangle triangle-bottom-right">
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat1.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat2.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat3.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat4.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat5.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat6.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat7.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat8.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat9.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat10.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat11.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat12.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat13.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat14.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat15.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat16.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat17.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat18.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat19.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat20.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat21.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat22.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat23.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat24.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat25.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat26.png') }}" alt="icon">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="{{ asset('theme/img/icon-chat27.png') }}" alt="icon">
							</a>
						</li>
					</ul>
				</div>
